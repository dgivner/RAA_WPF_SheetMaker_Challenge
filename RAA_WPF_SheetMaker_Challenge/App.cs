...
namespace RAA_WPF_SheetMaker_Challenge
{
    internal class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication app)
        {
            ...
            ButtonDataClass myButtonData = new ButtonDataClass("btnRAA_WPF_SheetMaker_Challenge", "Sheet Maker", Command.GetMethod(), Properties.Resources.Blue_32, Properties.Resources.Blue_16, "This is a tooltip");
